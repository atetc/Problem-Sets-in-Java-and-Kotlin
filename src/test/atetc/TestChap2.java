...
public class TestChap2 {
    ...
    public void testUniqueString_2_1(){
        ...
        LinkedList n = LinkedList.buildList(a);
        Q1.removeDuplicates(n);
        int[] b = {1, 2, 3, 4, 5};
        LinkedList m = LinkedList.buildList(b);
    ...
    public void testNthToLast_2_2(){
        ...
        assertTrue(Q2.nthToLast(list.head, 1).data == 5);
    }
    ...
    public void testDeleteNode_2_3(){
        ...
        Node middleNode = n.head.next.next;
    ...
    public void testFindBeginning_2_5(){
        LinkedList list = LinkedList.buildList(new int[]{1, 2, 3, 4, 5});
        list.head.next.next.next.next = list.head.next.next;

        Node<Integer> beginning = Q5.findBeginning(list.head);
