...
public class TestArrays {
    ...
    public void testIsLeftRightArraysSumEqual_3(){
        assertTrue(!Q3.isLeftRightArraysSumEqual(null));

        int[] arr = {4};
        assertTrue(!Q3.isLeftRightArraysSumEqual(arr));
    ...
    public void testArrays_7(){
        List<Q7.Machine> machines = new ArrayList<>();
        machines.add(new Q7.Machine(new long[]{4, 6}));
        machines.add(new Q7.Machine(new long[]{1, 2, 3}));
