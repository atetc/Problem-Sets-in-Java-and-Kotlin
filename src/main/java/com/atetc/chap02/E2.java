...
public class E2 {
    ...
    public LinkedList.Node<Integer> merge(LinkedList.Node<Integer> n1, LinkedList.Node<Integer> n2) {
        if (n1 == null) return n2;
        if (n2 == null) return n1;
        LinkedList.Node<Integer> retHead = null;
        LinkedList.Node<Integer> retTail = null;
