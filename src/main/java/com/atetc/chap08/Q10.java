...
public class Q10 {
    ...
    public static class HashTable<K, V> {
        ...
        public void printTable() {
            for (int i = 0; i < buckets.length; ++i) {
                ...
                Printer.print("[bucket " + i + "] ");
                for (Item<K, V> item : bucket) {
                    Printer.print(item.getKey() + ":" + item.getValue() + " ");
                }
                Printer.println();
            }
        }
    ...
    public static void main(String[] args) {
        ...
        map.printTable();
        Printer.println(map.get("none"));
        Printer.println(map.get("spiderman"));
        Printer.println(map.remove("none"));
        Printer.println(map.remove("spiderman"));
        Printer.println(map.get("spiderman"));
        map.printTable();
    }
}
