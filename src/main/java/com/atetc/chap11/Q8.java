...
public class Q8 {
    ...
    public static void main(String[] args) {
        Printer.println(getRankOfNumber(1));

        track(5); track(1); track(4); track(4); track(4);
        track(5); track(9); track(7); track(13); track(3);

        Printer.println(getRankOfNumber(1));
        Printer.println(getRankOfNumber(3));
        Printer.println(getRankOfNumber(4));
        Printer.println(getRankOfNumber(13));
        Printer.println(getRankOfNumber(200));
    }
}
