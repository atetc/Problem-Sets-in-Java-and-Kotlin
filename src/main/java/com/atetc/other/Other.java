...
public class Other {
    ...
    static void partition(LinkedList<Integer> list, int x) {
        ...
        LinkedList.Node<Integer> head1 = null, tail1 = null,
    ...
    static boolean isPalindrome(LinkedList list) {
        ...
        LinkedList.Node p1 = head, p2 = head;
        Stack s = new Stack();
    ...
    public static void main(String[] args) {
        Printer.println(isPalindrome(null));
        Printer.println(isPalindrome(LinkedList.buildList(new int[] {1})));
        Printer.println(isPalindrome(LinkedList.buildList(new int[] {1,1})));
        Printer.println(isPalindrome(LinkedList.buildList(new int[] {1,2,3,4,4,3,2,1})));
        Printer.println(isPalindrome(LinkedList.buildList(new int[] {1,2,3,4,4,3,3,2,1})));
    }
    ...
    public static void main2(String[] args) {
        ...
        Printer.println("isBSTNaive: " + isBSTNaive(r));
        Printer.println("isBST:      " + isBST(r));
        Printer.println("isBSTWrong: " + isBSTWrong(r));
        Printer.println();
        /*
         *   2
         *  / \
...
//    }
    ...
    private static void printScreen(byte[] screen, int width) {
        ...
        for (byte b : screen) {
            ...
            if (num % widthNum == 0) Printer.println();
            ++num;
        }
        Printer.println();
    }
...
//    so P(collision)=1-P(same_direction)=1-(1/2)^(n-1).
    ...
    public static void main3(String[] args) {
        ...
        Printer.println(intersect(l1, l2));
        Printer.println(intersect(l3, l1));
        Printer.println(intersect(l3, l3));
    }
    ...
    private static void test(int a, int b) {
        Printer.printfln("%d + %d = %d", a, b, add(a, b));
        Printer.printfln("%d - %d = %d", a, b, subtract(a, b));
        Printer.printfln("%d * %d = %d", a, b, multiply(a, b));
        Printer.printfln("%d / %d = %d", a, b, divide(a, b));
    }
