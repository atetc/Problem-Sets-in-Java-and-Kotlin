...
public class Q03 {
    ...
    public static void main(String[] args) {
        Printer.println(getMagicIndex(new int[] {-1, 0, 1, 3, 5, 7, 9}));
        Printer.println(getMagicIndexDup(new int[] {-1,0,2,2,2,2,3,4,6,9,11,12,13}));
        Printer.println(getMagicIndexDup(new int[] {-10,-5,2,2,2,3,4,7,9,12,13}));
        Printer.println(getAllMagicIndexDup(new int[] {-10,-5,2,2,2,3,4,7,9,12,13}));
    }
}
