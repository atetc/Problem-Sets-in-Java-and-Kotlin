...
public class Q04 {
    /*
     * Naive recursion
     * Compute P(n-1), clone the results, and then additional a(n) to each of these cloned sets.
    ...
    public static void main(String[] args) {
        Integer[] a = {1,3,5,7};
        Printer.println(getSubsetsRecursive(Arrays.asList(a)));
        Printer.println(getSubsetsIterative(Arrays.asList(a)));
    }
}
